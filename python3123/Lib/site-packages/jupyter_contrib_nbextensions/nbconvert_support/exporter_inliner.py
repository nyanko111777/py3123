...
class ExporterInliner(HTMLExporter):
    ...
    def default_config(self):
        ...
        extra_template_pathss = c.TemplateExporter.setdefault('extra_template_pathss', [])
        if contrib_templates_dir not in extra_template_pathss:
            extra_template_pathss.append(contrib_templates_dir)
