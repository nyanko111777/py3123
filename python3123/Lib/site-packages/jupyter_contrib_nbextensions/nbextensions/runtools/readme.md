...
`jupyter_nbconvert_config` or `jupyter_notebook_config` as `c.Exporter.extra_template_pathss`, see [Jupyter docs](https://jupyter-notebook.readthedocs.io/en/latest/config.html).
